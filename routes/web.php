...
Route::middleware(['auth', 'verified', 'setting'])->group(function () {
    ...
    Route::middleware('plan.access')->group(function () {
        ...
        Route::middleware('permission:manage-promotions')->group(function () {
            ...
            Route::get('hr/promotions/get-employee-current-designation/{employeeId}', [PromotionController::class, 'getEmployeeCurrentDesignation'])->name('hr.promotions.get-employee-current-designation');
        ...
        Route::middleware('permission:manage-interviews')->group(function () {
            ...
            Route::get('hr/recruitment/interviews/kanban', [InterviewController::class, 'kanban'])->name('hr.recruitment.interviews.kanban');
            ...
            Route::get('hr/recruitment/interviews/{interview}', [InterviewController::class, 'show'])->middleware('permission:view-interviews')->name('hr.recruitment.interviews.show');
        ...
        Route::middleware('permission:manage-offers')->group(function () {
            ...
            Route::get('hr/recruitment/offers/kanban', [OfferController::class, 'kanban'])->name('hr.recruitment.offers.kanban');
        ...
        Route::middleware('permission:manage-meetings')->group(function () {
            ...
            Route::get('meetings/meetings/{meeting}', [MeetingController::class, 'show'])->middleware('permission:view-meetings')->name('meetings.meetings.show');
