...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'toggle-status-branches', 'module' => 'branches', 'label' => 'Manage Branch Status', 'description' => 'Can toggle status of branches'],
            ...
            ['name' => 'toggle-status-departments', 'module' => 'departments', 'label' => 'Manage Departments Status', 'description' => 'Can toggle status of departments'],
            ...
            ['name' => 'toggle-status-designations', 'module' => 'designations', 'label' => 'Manage Designations Status', 'description' => 'Can toggle status of designations'],
            ...
            ['name' => 'manage-training-assessments', 'module' => 'training-assessments', 'label' => 'Manage Training Assessments', 'description' => 'Can manage training assessments'],
            ['name' => 'manage-any-training-assessments', 'module' => 'training-assessments', 'label' => 'Manage All Training Assessments', 'description' => 'Manage Any Training Assessments'],
            ['name' => 'manage-own-training-assessments', 'module' => 'training-assessments', 'label' => 'Manage Own Training Assessments', 'description' => 'Manage Limited Training Assessments that is created by own'],
            ['name' => 'view-training-assessments', 'module' => 'training-assessments', 'label' => 'View Training Assessments', 'description' => 'View training assessments'],
            ['name' => 'create-training-assessments', 'module' => 'training-assessments', 'label' => 'Create Training Assessments', 'description' => 'Can create training assessments'],
            ['name' => 'edit-training-assessments', 'module' => 'training-assessments', 'label' => 'Edit Training Assessments', 'description' => 'Can edit training assessments'],
            ['name' => 'delete-training-assessments', 'module' => 'training-assessments', 'label' => 'Delete Training Assessments', 'description' => 'Can delete training assessments'],
            ...
            // Need to Remove ['name' => 'manage-job-requisitions', 'module' => 'job_requisitions', 'label' => 'Manage Job Requisitions', 'description' => 'Can manage job requisitions'],
            // Need to Remove ['name' => 'manage-any-job-requisitions', 'module' => 'job_requisitions', 'label' => 'Manage All Job Requisitions', 'description' => 'Manage Any Job Requisitions'],
            // Need to Remove ['name' => 'manage-own-job-requisitions', 'module' => 'job_requisitions', 'label' => 'Manage Own Job Requisitions', 'description' => 'Manage Limited Job Requisitions that is created by own'],
            // Need to Remove ['name' => 'view-job-requisitions', 'module' => 'job_requisitions', 'label' => 'View Job Requisitions', 'description' => 'View Job Requisitions'],
            // Need to Remove ['name' => 'create-job-requisitions', 'module' => 'job_requisitions', 'label' => 'Create Job Requisitions', 'description' => 'Can create job requisitions'],
            // Need to Remove ['name' => 'edit-job-requisitions', 'module' => 'job_requisitions', 'label' => 'Edit Job Requisitions', 'description' => 'Can edit job requisitions'],
            // Need to Remove ['name' => 'delete-job-requisitions', 'module' => 'job_requisitions', 'label' => 'Delete Job Requisitions', 'description' => 'Can delete job requisitions'],
            // Need to Remove ['name' => 'approve-job-requisitions', 'module' => 'job_requisitions', 'label' => 'Approve Job Requisitions', 'description' => 'Can approve job requisitions'],
            ...
            // Need to Remove ['name' => 'manage-contract-amendments', 'module' => 'contract_renewals', 'label' => 'Manage Contract Renewals', 'description' => 'Can manage contract renewals'],
            // Need to Remove ['name' => 'manage-any-contract-renewals', 'module' => 'contract_renewals', 'label' => 'Manage All Contract Renewals', 'description' => 'Manage Any Contract Renewals'],
            // Need to Remove ['name' => 'manage-own-contract-renewals', 'module' => 'contract_renewals', 'label' => 'Manage Own Contract Renewals', 'description' => 'Manage Limited Contract Renewals that is created by own'],
            // Need to Remove ['name' => 'view-contract-renewals', 'module' => 'contract_renewals', 'label' => 'View Contract Renewals', 'description' => 'View Contract Renewals'],
            // Need to Remove ['name' => 'create-contract-renewals', 'module' => 'contract_renewals', 'label' => 'Create Contract Renewals', 'description' => 'Can create contract renewals'],
            // Need to Remove ['name' => 'edit-contract-renewals', 'module' => 'contract_renewals', 'label' => 'Edit Contract Renewals', 'description' => 'Can edit contract renewals'],
            // Need to Remove ['name' => 'delete-contract-renewals', 'module' => 'contract_renewals', 'label' => 'Delete Contract Renewals', 'description' => 'Can delete contract renewals'],
            // Need to Remove ['name' => 'approve-contract-renewals', 'module' => 'contract_renewals', 'label' => 'Approve Contract Renewals', 'description' => 'Can approve contract renewals'],
            // Need to Remove ['name' => 'reject-contract-renewals', 'module' => 'contract_renewals', 'label' => 'Reject Contract Renewals', 'description' => 'Can reject contract renewals'],
            ...
            ['name' => 'view-leave-balance-sync-history', 'module' => 'leave_balances', 'label' => 'View Leave Balance Sync History', 'description' => 'Can view leave balance sync history'],
            ['name' => 'manage-leave-balance-sync-history', 'module' => 'leave_balances', 'label' => 'Manage Leave Balance Sync History', 'description' => 'Can manage leave balance sync history'],
            ['name' => 'manage-any-leave-balance-sync-history', 'module' => 'leave_balances', 'label' => 'Manage All Leave Balance Sync History', 'description' => 'Can manage any leave balance sync history'],
            ['name' => 'manage-own-leave-balance-sync-history', 'module' => 'leave_balances', 'label' => 'Manage Own Leave Balance Sync History', 'description' => 'Can manage own leave balance sync history'],
            ['name' => 'sync-leave-balances', 'module' => 'leave_balances', 'label' => 'Sync Leave Balances', 'description' => 'Can sync leave balances for current year'],
            ...
            // Need to Remove ['name' => 'send-payslips', 'module' => 'payslips', 'label' => 'Send Payslips', 'description' => 'Can send payslips via email'],
            ...
            ['name' => 'update-working-days-settings', 'module' => 'working_days', 'label' => 'Update Working Days', 'description' => 'Update Working Days'],
