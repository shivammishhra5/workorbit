...
export function PageTemplate({
  ...
  return (
    <AppLayout breadcrumbs={pageBreadcrumbs}>
      ...
      <div className="flex flex-1 flex-col gap-4 pt-4 pb-[50px] px-[50px] print:p-0 print:gap-2">
        ...
        {/* Content */}
        <div className={noPadding ? "" : "rounded-xl border p-6 print:border-0 print:p-0"}>
          {children}
        </div>
      </div>
