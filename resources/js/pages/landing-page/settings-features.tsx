      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-3">
            ...
            >
              <option value="grid" className='cursor-pointer'>Grid</option>
              <option value="list" className='cursor-pointer'>List</option>
              <option value="cards" className='cursor-pointer'>Cards</option>
              <option value="alternating" className='cursor-pointer'>Alternating</option>
            </select>
          </div>
          ...
          <div className="space-y-3">
            ...
            <select
              ...
              className="w-full p-2 border border-gray-300 rounded-md cursor-pointer"
            >
              <option value="1" className='cursor-pointer'>1 Column</option>
              <option value="2" className='cursor-pointer'>2 Columns</option>
              <option value="3" className='cursor-pointer'>3 Columns</option>
              <option value="4" className='cursor-pointer'>4 Columns</option>
            </select>
          </div>
        </div>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-3">
                  ...
                  <select
                    ...
                    className="w-full p-2 border border-gray-300 rounded-md cursor-pointer"
                  >
                    <option value="qr-code" className='cursor-pointer'>QR Code</option>
                    <option value="smartphone" className='cursor-pointer'>Smartphone</option>
                    <option value="share" className='cursor-pointer'>Share</option>
                    <option value="bar-chart" className='cursor-pointer'>Bar Chart</option>
                    <option value="globe" className='cursor-pointer'>Globe</option>
                    ...
                    <option value="lock" className='cursor-pointer'>Lock</option>
                    <option value="wifi" className='cursor-pointer'>Wifi</option>
                    <option value="heart" className='cursor-pointer'>Heart</option>
                    <option value="dollar-sign" className='cursor-pointer'>Dollar Sign</option>
                    <option value="clock" className='cursor-pointer'>Clock</option>
                    <option value="user-plus" className='cursor-pointer'>User Plus</option>
                    <option value="award" className='cursor-pointer'>Award</option>
                    <option value="bar-chart-2" className='cursor-pointer'>Bar Chart</option>
                  </select>
                </div>
