    ...
    return (
        ...
        >
            <form className="space-y-5" onSubmit={submit}>
                <div className="mb-4">
                    <Label htmlFor="name" required className="block text-sm font-medium text-gray-900">{t("Full name")}</Label>
                    <Input
                        id="name"
                        type="text"
                        required
                ...
                <div className="mb-4">
                    <Label htmlFor="email" required className="block text-sm font-medium text-gray-900">{t("Email address")}</Label>
                    <Input
                        id="email"
                        type="email"
                        required
                ...
                <div className="mb-4">
                    <Label htmlFor="password" required className="block text-sm font-medium text-gray-900">{t("Password")}</Label>
                    <Input
                        id="password"
                        type="password"
                        required
                ...
                <div className="mb-4">
                    <Label htmlFor="password_confirmation" required className="block text-sm font-medium text-gray-900">{t("Confirm password")}</Label>
                    <Input
