...
export default function CandidateOnboardingShow() {
  ...
  return (
    <PageTemplate
      ...
      description={t("View the onboarding checklist and progress for this candidate.")}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-900 dark:text-gray-100 mt-1">
                {candidateOnboarding.start_date ? window?.appSettings?.formatDateTimeSimple(candidateOnboarding.start_date, false) || '-' : '-'}
              </p>
            </div>
            <div>
