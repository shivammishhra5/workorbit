...
export default function CustomQuestions() {
  ...
  const { auth, customQuestions, filters: pageFilters = {}, globalSettings } = usePage().props as any;
  ...
  const handleFormSubmit = (formData: any) => {
    if (formMode === 'create') {
      if (!globalSettings?.is_demo) toast.loading(t('Creating custom question...'));
      ...
      if (!globalSettings?.is_demo) toast.loading(t('Updating custom question...'));
  ...
  const handleDeleteConfirm = () => {
    if (!globalSettings?.is_demo) toast.loading(t('Deleting custom question...'));
  ...
  return (
    <PageTemplate
      title={t("Custom Questions")}
      description={t("Manage custom questions used in job application forms.")}
          ...
          fields: [
            {
              ...
              type: 'textarea',
              required: true,
              placeholder: t('e.g. What is your expected salary range?')
            },
            {
              name: 'required',
              label: t('Required'),
