...
export default function Branches() {
  ...
  return (
    <PageTemplate
      title={t("Branches")}
      description={t("Manage your company branches and locations.")}
      url="/hr/branches"
      actions={pageActions}
    ...
    >
      ...
      <CrudFormModal
        ...
        formConfig={{
          fields: [
            { name: 'name', label: t('Branch Name'), type: 'text', required: true, placeholder: t('e.g. Head Office, New York Branch') },
            { name: 'address', label: t('Address'), type: 'textarea', placeholder: t('e.g. 123 Main Street, Suite 100') },
            { name: 'city', label: t('City'), type: 'text', placeholder: t('e.g. New York') },
            { name: 'state', label: t('State/Province'), type: 'text', placeholder: t('e.g. New York') },
            { name: 'country', label: t('Country'), type: 'text', placeholder: t('e.g. United States') },
            { name: 'zip_code', label: t('ZIP/Postal Code'), type: 'text', placeholder: t('e.g. 10001') },
            { name: 'phone', label: t('Phone'), type: 'text', placeholder: t('e.g. +1 234 567 8900') },
            { name: 'email', label: t('Email'), type: 'email', placeholder: t('e.g. branch@example.com') },
            {
              name: 'status',
              label: t('Status'),
              type: 'select',
      ...
      <Dialog open={!!viewingItem} onOpenChange={() => setViewingItem(null)}>
        {viewingItem && <View branch={viewingItem} />}
      </Dialog>
    </PageTemplate>
  );
}
