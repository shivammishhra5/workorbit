...
export default function CreateEmployeeReview() {
  ...
  const { employees, reviewCycles, globalSettings } = usePage().props as any;
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!globalSettings?.is_demo) toast.loading(t('Scheduling employee review...'));
  ...
  return (
    <PageTemplate
      ...
      description={t("Schedule a new performance review for an employee.")}
