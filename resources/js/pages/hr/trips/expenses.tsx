...
export default function TripExpenses() {
  ...
  const { auth, trip, expenses, globalSettings } = usePage().props as any;
  ...
  const handleFormSubmit = (formData: any) => {
    ...
    if (formMode === 'create') {
      if (!globalSettings?.is_demo) toast.loading(t('Adding expense...'));
      ...
      if (!globalSettings?.is_demo) toast.loading(t('Updating expense...'));
  ...
  const handleDeleteConfirm = () => {
    if (!globalSettings?.is_demo) toast.loading(t('Deleting expense...'));
  ...
  return (
    <PageTemplate
      ...
      description={t("Manage trip expenses and receipts.")}
      actions={pageActions}
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div>
              <p className="text-xs font-medium text-gray-500 dark:text-gray-400 tracking-wide mb-1">{t('Employee')}</p>
              <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{trip.employee?.name || '-'}</p>
            </div>
            <div>
              <p className="text-xs font-medium text-gray-500 dark:text-gray-400 tracking-wide mb-1">{t('Destination')}</p>
              <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{trip.destination || '-'}</p>
            </div>
            <div>
              <p className="text-xs font-medium text-gray-500 dark:text-gray-400 tracking-wide mb-1">{t('Purpose')}</p>
              <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{trip.purpose || '-'}</p>
            </div>
            <div>
              <p className="text-xs font-medium text-gray-500 dark:text-gray-400 tracking-wide mb-1">{t('Start Date')}</p>
            ...
            <div>
              <p className="text-xs font-medium text-gray-500 dark:text-gray-400 tracking-wide mb-1">{t('End Date')}</p>
            ...
            <div>
              <p className="text-xs font-medium text-gray-500 dark:text-gray-400 tracking-wide mb-1">{t('Status')}</p>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
              <p className="text-xs font-semibold text-blue-700 dark:text-blue-400 tracking-wide mb-2">{t('Total Expenses')}</p>
            ...
            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
              <p className="text-xs font-semibold text-green-700 dark:text-green-400 tracking-wide mb-2">{t('Reimbursable')}</p>
            ...
            <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
              <p className="text-xs font-semibold text-purple-700 dark:text-purple-400 tracking-wide mb-2">{t('Advance Amount')}</p>
        ...
        formConfig={{
          fields: [
            ...
            },
            {
              ...
              label: t('Description'),
              type: 'textarea',
              placeholder: t('e.g. Taxi fare from airport to hotel...')
            },
            {
              name: 'receipt',
              label: t('Receipt'),
