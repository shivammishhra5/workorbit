                                ...
                                <div className="grid grid-cols-1 gap-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-3">
                                            <div className="flex items-center justify-between">
                                                <Label required htmlFor="defaultCurrency" className="font-medium">{t("Default Currency")}</Label>
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-center justify-between">
                                                <Label required htmlFor="decimalFormat" className="font-medium">{t("Decimal Places")}</Label>
                                                <TooltipProvider>
                                                    <Tooltip>
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-center justify-between">
                                                <Label required htmlFor="currencySymbolPosition" className="font-medium">{t("Symbol Position")}</Label>
                                                <TooltipProvider>
                                                    <Tooltip>
                                                        <TooltipTrigger asChild>
                                                            <Info className="h-4 w-4 text-muted-foreground" />
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-center justify-between">
                                                <Label required htmlFor="decimalSeparator" className="font-medium">{t("Decimal Separator")}</Label>
                                                <TooltipProvider>
                                                    <Tooltip>
                                                        <TooltipTrigger asChild>
                                                            <Info className="h-4 w-4 text-muted-foreground" />
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-center justify-between">
                                                <Label required htmlFor="thousandsSeparator" className="font-medium">{t("Thousands Separator")}</Label>
                                                <TooltipProvider>
                                                    <Tooltip>
                                                        <TooltipTrigger asChild>
                                                            <Info className="h-4 w-4 text-muted-foreground" />
