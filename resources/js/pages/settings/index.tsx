...
export default function Settings() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // }
      if (scrollPosition >= joiningLetterSettingsPosition && joiningLetterSettingsPosition > 0) {
        setActiveSection('joining-letter-settings');
      } else if (scrollPosition >= experienceCertificateSettingsPosition && experienceCertificateSettingsPosition > 0) {
        setActiveSection('experience-certificate-settings');
      } else if (scrollPosition >= nocSettingsPosition && nocSettingsPosition > 0) {
        setActiveSection('noc-settings');
      } else if (scrollPosition >= zektoSettingsPosition && zektoSettingsPosition > 0) {
        setActiveSection('zekto-settings');
      } else if (scrollPosition >= ipRestrictionSettingsPosition && ipRestrictionSettingsPosition > 0) {
  ...
  return (
    ...
    >
      ...
      <div className={`flex flex-col md:flex-row gap-8`} dir={position === 'right' ? 'rtl' : 'ltr'}>
        ...
        {/* Sidebar Navigation */}
        <div className="md:w-74 flex-shrink-0">
