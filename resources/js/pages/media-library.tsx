...
import { Upload, Search, X, Plus, Info, Copy, Download, MoreHorizontal, Image as ImageIcon, Calendar, HardDrive, BarChart3, Home, Star, Clock, Trash2, Folder, FolderOpen, Grid3X3, List, Settings, Eye } from 'lucide-react';
...
export default function MediaLibraryDemo() {
  ...
  return (
    <PageTemplate
      ...
      description={t('Manage your media files and organize them in folders')}
      actions={pageActions}
    >
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          ...
          <Card className="flex-1 flex flex-col min-h-0 lg:h-[calc(100vh-20rem)]">
            <CardContent className="p-3 lg:p-6 flex flex-col h-full overflow-hidden bg-[#F0F0F1] dark:bg-gray-800">
              {loading ? (
      ...
      <Dialog open={infoModalOpen} onOpenChange={setInfoModalOpen}>
        <DialogContent className="max-w-[95vw] sm:max-w-[90vw] md:max-w-4xl lg:max-w-5xl xl:max-w-6xl mx-auto h-[95vh] p-0 overflow-hidden">
          ...
          {selectedMediaInfo && (
            <div className="flex flex-col lg:flex-row lg:h-[calc(95vh-4rem)] overflow-hidden">
              {/* Image Display Area - Fully Responsive */}
              <div className="flex-1 flex items-center justify-center bg-[#F0F0F1] dark:bg-gray-800 p-3 sm:p-4 md:p-6 min-h-[200px] sm:min-h-[250px] md:min-h-[300px] lg:min-h-0 max-h-[40vh] lg:max-h-none overflow-hidden">
              ...
              <div className="w-full lg:w-80 xl:w-96 border-t lg:border-t-0 lg:border-l bg-background p-3 sm:p-4 md:p-6 overflow-y-auto max-h-[45vh] lg:max-h-none lg:h-full pb-8">
